...
from core.ai_analyzer import analyze_savings, load_api_key, save_api_key
...
class AnalysisWorker(QThread):
    ...
    def __init__(self, api_key: str, months: int):
        super().__init__()
    ...
    def run(self) -> None:
        try:
            result = analyze_savings(self._api_key, self._months)
...
class AIAnalysisPage(QWidget):
    ...
    def _init_ui(self) -> None:
        ...
        self._key_edit.setPlaceholderText("输入 DeepSeek API Key")
    ...
    def _save_config(self) -> None:
        ...
        if key:
            save_api_key(key)
            self._status_label.setText("✅ API Key 已保存")
    ...
    def _on_analyze(self) -> None:
        ...
        # 启动后台线程
        self._worker = AnalysisWorker(api_key, months)
